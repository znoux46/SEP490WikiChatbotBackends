...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Version = "v1",
        Description = "API for Wikipedia Chatbot Backend"
    });
...
var jwtIssuer = builder.Configuration["Jwt:Issuer"] ?? "WikiChatbotBackends";
var jwtAudience = builder.Configuration["Jwt:Audience"] ?? "WikiChatbotBackends";
